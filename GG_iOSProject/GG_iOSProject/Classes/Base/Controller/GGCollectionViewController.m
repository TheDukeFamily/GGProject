...
#import "GGVerticalFlowLayout.h"
#import "GGHorizontalFlowLayout.h"

@interface GGCollectionViewController ()<GGVerticalFlowLayoutDelegate>
...
{
    UIEdgeInsets contentInset = self.collectionView.contentInset;
    contentInset.bottom -= self.collectionView.mj_footer.gg_height;
...
- (UICollectionViewLayout *)collectionViewController:(GGCollectionViewController *)collectionViewController layoutForCollectionView:(UICollectionView *)collectionView
{
    GGVerticalFlowLayout *myLayout = [[GGVerticalFlowLayout alloc] initWithDelegate:self];
    return myLayout;
}
