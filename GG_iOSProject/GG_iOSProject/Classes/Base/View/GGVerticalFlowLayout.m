...
@interface GGVerticalFlowLayout()
...
@implementation GGVerticalFlowLayout
...
- (id<GGVerticalFlowLayoutDelegate>)delegate
{
    return (id<GGVerticalFlowLayoutDelegate>)self.collectionView.dataSource;
}
